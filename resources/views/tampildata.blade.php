                ...
                <form action="/updatedata/{{ $data->id }}" method= "POST" enctype="multipart/form-data">
                  @csrf
                      <div class="mb-3">  
                        ...
                        <input type="number" name="pemasukan" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $data->pemasukan }}">
                      </div>
                      
                      <div class="mb-3">  
                        <label for="exampleInputEmail1" class="form-label">MODAL</label>
                        <input type="number" name="modal" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $data->modal }}">
                      </div>
                ...
                <form action="/updatedata/{{ $data->id }}" method= "POST" enctype="multipart/form-data">
                  @csrf
                      <div class="mb-3">
                        ...
                        <input type="text" name="tanggal" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $data->tanggal }}">
                      </div>
                      <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">KATEGORI</label>
                            <select class="form-select" name="kategori" aria-label="Default select example">
